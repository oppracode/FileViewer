  ...
  async (filePath: string) => {
    ...
    try {
      ...
      await axios.post(
        ...
        {
          path: filePath, // Provide the path of the file you want to delete
        },
        {
          headers: {
            Authorization: `Bearer ${accessToken}`,
      ...
      // You might want to dispatch another action to update your state after deletion
      // For example, dispatch an action to remove the file from your state
